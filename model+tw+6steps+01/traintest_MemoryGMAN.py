...
def getModel():
    ...
    print(SE.size())
    model = MemoryGMAN(SE, N=47, SE_dim=64, TE_dim=opt.his_len+opt.seq_len, timestep_in=opt.his_len, timestep_out=opt.seq_len, device=device).to(device)
