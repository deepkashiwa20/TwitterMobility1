...
import logging
import Metrics
from ASTGCNHour import *
from Utils import get_pref_id, get_flow, get_adj, get_seq_data, getXSYS, get_twitter
...
def getModel():
    ...
    model = ASTGCN(device, cheb_polynomials, num_for_predict=opt.seq_len, len_input=opt.his_len*(WEEK+DAY+HOUR), num_of_vertices=num_variable, in_channels=opt.channelin).to(device)
