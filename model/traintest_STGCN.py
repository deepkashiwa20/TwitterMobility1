...
import Metrics
from STGCN import *
from Utils import get_pref_id, get_flow, get_adj, get_seq_data, getXSYS_single, getXSYS
...
def main():
    ...
    testXS_multi, testYS_multi = refineXSYS(testXS_multi, testYS_multi) # new added
