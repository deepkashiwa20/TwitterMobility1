...
import struct
import argparse
from GAN_origin import Generator
from GAN_origin import Discriminator
...
tw_condition, his_condition = False, True
##############  Typhoon-Inflow ###############
...
path = f'./{event}_{flow_type}_{condition_flag}_ORIGINGAN_' + time.strftime('%Y%m%d%H%M', time.localtime())
