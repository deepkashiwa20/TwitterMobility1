...
import logging
import Metrics
from TransformerSimple import Transformer
...
def getModel():
    model = Transformer(device, feature=num_variable*channel, time_in=opt.his_len, dmodel=64, nhead=8, num_layers=1).to(device)
    return model
