...
import Metrics
from GMAN import *
from Utils import get_pref_id, get_flow, get_adj, sym_adj, get_seq_data, getXSYS_single, getXSYS, get_onehottime
...
def getModel():
    ...
    print(SE.size())
    model = GMAN(SE, SE_dim=64, TE_dim=32, timestep_in=opt.his_len, device=device).to(device)
    return model
