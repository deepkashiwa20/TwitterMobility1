...
def getModel():
    ks, kt, bs, T, n, p = 3, 3, [[opt.channelin, 16, 64], [64, 16, 64]], opt.his_len, num_variable, 0
    ...
    summary(model, (opt.channelin, opt.his_len, num_variable), device=device)
    return model
...
logger.info('channel', opt.channelin)
