...
if __name__ == '__main__':
    ...
    att_noise1 = np.load(f'../model_ours/con_mem/typhoon-outflow_noise1_202204261154/MemeSTNnoise_att_score.npy')
    att_noise2 = np.load(f'../model_ours/con_mem/typhoon-outflow_noise2_202204261220/MemeSTNnoise_att_score.npy')

    # test start: 10/06 10AM
    # +14h start: 10/07 0AM
    att_with = att_with[14:14+24*14, 5:]
    att_without = att_without[14:14+24*14, 6:]

    att_noise = att_noise1[14:14+24*14, 7:]

    plot_con_mem(att_with, att_noise)
